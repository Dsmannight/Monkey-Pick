...
struct MiscStocks: Decodable {
    //Expected information to be recieved from local json file
    var Symbol: DecodableDictionary?
    var Name: DecodableDictionary?
    var Sector: DecodableDictionary?
    var Industry: DecodableDictionary?
}

// code from: https://github.com/levantAJ/AnyCodable/blob/master/AnyCodable/DecodingContainer%2BAnyCollection.
